...
function loadConfig(options = {}) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const redoclyClient = (0, utils_1.isEmptyObject)(fs) ? undefined : new redocly_1.RedoclyClient();
...
function getConfig(options = {}) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            if (!configPath || !(yield externalRefResolver.resolveDocument(null, configPath))) {
                return {};
            }
        }
        catch (e) {
